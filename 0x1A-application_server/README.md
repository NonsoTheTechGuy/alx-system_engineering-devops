...
![image](https://github.com/user-attachments/assets/99bfaa6f-3268-43d6-ae33-bcc2c619af0d)
...
499388-web-01	ubuntu	54.237.90.74	running	
499388-web-02				
499388-lb-01				
```
...
- Check out these articles/docs for clues on how to configure `Nginx`: [Understanding Nginx Server and Location Block Selection Algorithms](https://intranet.alxswe.com/rltoken/0xFZ6umndhIH19cSGFnexg), [Understanding Nginx Location Blocks Rewrite Rules](https://intranet.alxswe.com/rltoken/hi8oqmYQG0TkCTtRr5o9hg), [Nginx Reverse Proxy](https://intranet.alxswe.com/rltoken/8O-01TMh2X22EmYNps0X-Q).
...
![image](https://github.com/user-attachments/assets/0612f6bc-44e9-4ff3-b8d1-367e2a6da52a)
